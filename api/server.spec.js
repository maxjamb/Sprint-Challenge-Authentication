  ...
  describe("[POST] /api/auth/login", () => {
    ...
    it("can't login without password", async () => {
      try {
        ...
        console.error(
          "Error while testing [POST] /api/auth/login -> can't login without password ->",
          error
        );
      }
    });
  ...
  describe("[POST] /api/jokes", () => {
    ...
    it("gets 200 OK when logged in", async () => {
      try {
        ...
        console.error(
          "Error while testing [POST] /api/jokes -> gets 200 OK when logged in ->",
          error
        );
      }
    });
    it("gets blocked if not logged in", async () => {
      try {
        ...
        console.error(
          "Error while testing [POST] /api/jokes -> gets blocked if not logged in ->",
          error
        );
      }
    });
